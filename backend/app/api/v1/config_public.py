...
def public_config() -> dict[str, str | bool | int | list[str]]:
    ...
    return {
        ...
        "daily_limit_trial": int(getattr(settings, "daily_limit_trial", 50)),
        "trial_period_days": int(getattr(settings, "trial_period_days", 7)),
        "base_tier_price_inr": int(getattr(settings, "base_tier_price_inr", 1)),
