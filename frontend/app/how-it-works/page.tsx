...
export const metadata: Metadata = {
  title: "How it works — NyayaSetu",
  description: "Three steps: describe, route and clarify, then verify with official sources.",
};

export default function HowItWorksPage() {
  const b = marketingBundle("en");
  return (
    <MarketingShell locale="en" pathSuffix="/how-it-works">
