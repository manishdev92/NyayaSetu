...
export const metadata: Metadata = {
  title: "विशेषताएँ — NyayaSetu",
  description: "चैट, मसौदा, प्राधिकरण संदर्भ, अपलोड।",
};

export default function FeaturesHiPage() {
  const b = marketingBundle("hi");
  return (
    <MarketingShell locale="hi" pathSuffix="/features">
