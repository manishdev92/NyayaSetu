...
export const metadata: Metadata = {
  ...
  description: "संरचित मार्गदर्शन, मसौदा, और अगले कदम। वकालत संस्थान नहीं—आधिकारिक स्रोतों से सत्यापित करें।",
};
    ...
    <MarketingShell locale="hi" pathSuffix="">
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
        ...
        <div className="mt-12 text-center">
          <Link href="/hi/features" className="text-sm font-semibold text-amber-900 underline decoration-amber-800/30">
