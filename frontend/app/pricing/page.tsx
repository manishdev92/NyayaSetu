...
export const metadata: Metadata = {
  title: "Pricing — NyayaSetu",
  description: "Guest, signed-in, and optional Pro tiers—actual limits come from your deployment.",
};

export default function PricingPage() {
  const b = marketingBundle("en");
  return (
    <MarketingShell locale="en" pathSuffix="/pricing">
